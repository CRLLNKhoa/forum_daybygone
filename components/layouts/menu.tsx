  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Link href="/single-rewind" className="flex items-center h-[80px] bg-[#d3e3fd] rounded-xl p-4 shadow-lg
        ...
        <Link href="/double-rewind" className="flex items-center h-[80px] bg-[#e3e3e3] rounded-xl p-4 shadow-lg
        ...
        <Link href="/time-rewind" className="flex items-center h-[80px] bg-[#c2e7ff] rounded-xl p-4 shadow-lg
        ...
        <Link href="/teams" className="flex items-center h-[80px] bg-[#efd197] rounded-xl p-4 shadow-lg
        ...
        <Link href="/world-tree" className="flex items-center h-[80px] bg-[#c495ef] rounded-xl p-4 shadow-lg
        ...
        <Link href="/calculator" className="flex items-center h-[80px] bg-[#cd7c77] rounded-xl p-4 shadow-lg
        ...
        <Link href="/blogs" className="flex items-center h-[80px] bg-[#c4cd77] rounded-xl p-4 shadow-lg
